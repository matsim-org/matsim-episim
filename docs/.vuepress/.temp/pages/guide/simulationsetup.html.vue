...
<strong><RouteLink to="/guide/episimsimulation.html##vaccination-model">Vaccination Model</RouteLink></strong>).</p>
</li>
<li>
...
<em><RouteLink to="/guide/episimsimulation.html##disease-progression-model">Disease Progression Model</RouteLink></em>) specifies the transition probabilities
...
applied to the population throughout the simulation (see <em><RouteLink to="/guide/episimsimulation.html##disease-progression-model">Disease Progression Model</RouteLink></em>).</p>
