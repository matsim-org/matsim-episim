...
<p><img src="@source/versions/v0.0.1/images/traj2.png" alt="Example Image"></p>
...
<strong><RouteLink to="/versions/v0.0.1/documentation/episimsimulation.html##vaccination-model">Vaccination Model</RouteLink></strong>).</p>
</li>
<li>
...
<em><RouteLink to="/versions/v0.0.1/documentation/episimsimulation.html##disease-progression-model">Disease Progression Model</RouteLink></em>) specifies the transition probabilities
...
applied to the population throughout the simulation (see <em><RouteLink to="/versions/v0.0.1/documentation/episimsimulation.html##disease-progression-model">Disease Progression Model</RouteLink></em>).</p>
